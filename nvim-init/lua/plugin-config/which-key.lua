...
local mappings = {
    ...
    ["w"] = {"<cmd>w<CR>", "Save"},
    ["q"] = {":q<CR>", "Quit"},
    ["wa"] = {":wqa!<CR>", "Force Save All"},
    ["qa"] = {":qa!<CR>", "Force Quit All"},
    ...
    t = {
        ...
        p = {"<cmd>lua _PYTHON_TOGGLE()<cr>", "Python Shell"}, -- Python Terminal
    ...
    ["tpr"] = {"<cmd>lua _PYTHON_RUN_TOGGLE()<cr>", "Python Run"} -- Python Terminal
}
